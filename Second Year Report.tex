...
In section \ref{Section:Strategic Patroller and Strategic Attacker} we will present an issue with this lemma.
...
However $S_{2}$ uses the diametric attack, so will exhibit the issue discussed in Section \ref{Section:Strategic Patroller and Strategic Attacker} and will be corrected.
